...
try {
  ...
  await evaluate("(()=>{const input=document.querySelector('dialog input');const setter=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,'value').set;setter.call(input,'项目名称');input.dispatchEvent(new InputEvent('input',{bubbles:true,composed:true,inputType:'insertText',data:'项目名称'}))})()")
